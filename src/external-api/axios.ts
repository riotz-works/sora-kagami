...
export class AxiosHttpClient {
   ...
   */
  public post<T>(url: string, data?: Record<string, unknown>): Promise<AxiosResponse<T>> {
   ...
   * @param params Request parameter.
   */
  public stream(url: string, params?: Record<string, unknown>): Promise<AxiosResponse<Buffer>> {

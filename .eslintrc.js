module.exports = {
  ...
  rules: {
    ...
    'id-length':  [ 'error', { exceptions: [ 'x', 'y', 'z' ]}],                 // To allow general key words.
    'no-console': 'off',                                                        // To allow for CLI project
    '@typescript-eslint/camelcase': [ 'error', { allow: [ 'response_type' ]}],  // To allow specified in an external service such as Slack.
